...
func (suite *LabelsSuite) SetupTest() {
	...
	suite.fooAsText = "heritage=external-ips,external-ips/owner=foo-owner,external-ips/resource=foo-resource"
	...
	suite.barText = "heritage=external-ips,,external-ips/owner=bar-owner,external-ips/resource=bar-resource,external-ips/new-key=bar-new-key,random=stuff,no-equal-sign,," //also has some random gibberish
