...
func testTXTRegistryRecordsPrefixed(t *testing.T) {
	...
	p.ApplyChanges(&plan.Changes{
		Create: []*endpoint.Endpoint{
			...
			newEndpointWithOwner("txt.bar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner\"", endpoint.RecordTypeTXT, ""),
			...
			newEndpointWithOwner("txt.tar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner-2\"", endpoint.RecordTypeTXT, ""),
...
func testTXTRegistryRecordsNoPrefix(t *testing.T) {
	...
	p.ApplyChanges(&plan.Changes{
		Create: []*endpoint.Endpoint{
			newEndpointWithOwner("foo.test-zone.example.org", "foo.loadbalancer.com", endpoint.RecordTypeCNAME, ""),
			newEndpointWithOwner("bar.test-zone.example.org", "my-domain.com", endpoint.RecordTypeCNAME, ""),
			newEndpointWithOwner("txt.bar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner,external-ips/resource=ingress/default/my-ingress\"", endpoint.RecordTypeTXT, ""),
			newEndpointWithOwner("txt.bar.test-zone.example.org", "baz.test-zone.example.org", endpoint.RecordTypeCNAME, ""),
			newEndpointWithOwner("qux.test-zone.example.org", "random", endpoint.RecordTypeTXT, ""),
			newEndpointWithOwner("tar.test-zone.example.org", "tar.loadbalancer.com", endpoint.RecordTypeCNAME, ""),
			newEndpointWithOwner("txt.tar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner-2\"", endpoint.RecordTypeTXT, ""),
...
func testTXTRegistryApplyChangesWithPrefix(t *testing.T) {
	...
	p.ApplyChanges(&plan.Changes{
		Create: []*endpoint.Endpoint{
			...
			newEndpointWithOwner("qux.test-zone.example.org", "random", endpoint.RecordTypeTXT, ""),
			newEndpointWithOwner("tar.test-zone.example.org", "tar.loadbalancer.com", endpoint.RecordTypeCNAME, ""),
			newEndpointWithOwner("txt.tar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner\"", endpoint.RecordTypeTXT, ""),
			newEndpointWithOwner("foobar.test-zone.example.org", "foobar.loadbalancer.com", endpoint.RecordTypeCNAME, ""),
	...
	expected := &plan.Changes{
		Create: []*endpoint.Endpoint{
			...
			newEndpointWithOwner("txt.new-record-1.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner,external-ips/resource=ingress/default/my-ingress\"", endpoint.RecordTypeTXT, ""),
		},
		Delete: []*endpoint.Endpoint{
			newEndpointWithOwner("foobar.test-zone.example.org", "foobar.loadbalancer.com", endpoint.RecordTypeCNAME, "owner"),
			newEndpointWithOwner("txt.foobar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner\"", endpoint.RecordTypeTXT, ""),
		...
		UpdateNew: []*endpoint.Endpoint{
			newEndpointWithOwnerResource("tar.test-zone.example.org", "new-tar.loadbalancer.com", endpoint.RecordTypeCNAME, "owner", "ingress/default/my-ingress-2"),
			newEndpointWithOwner("txt.tar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner,external-ips/resource=ingress/default/my-ingress-2\"", endpoint.RecordTypeTXT, ""),
		},
		UpdateOld: []*endpoint.Endpoint{
			newEndpointWithOwner("tar.test-zone.example.org", "tar.loadbalancer.com", endpoint.RecordTypeCNAME, "owner"),
			newEndpointWithOwner("txt.tar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner\"", endpoint.RecordTypeTXT, ""),
...
func testTXTRegistryApplyChangesNoPrefix(t *testing.T) {
	...
	expected := &plan.Changes{
		Create: []*endpoint.Endpoint{
			...
			newEndpointWithOwner("new-record-1.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner\"", endpoint.RecordTypeTXT, ""),
		},
		Delete: []*endpoint.Endpoint{
			newEndpointWithOwner("foobar.test-zone.example.org", "foobar.loadbalancer.com", endpoint.RecordTypeCNAME, "owner"),
			newEndpointWithOwner("foobar.test-zone.example.org", "\"heritage=external-ips,external-ips/owner=owner\"", endpoint.RecordTypeTXT, ""),
